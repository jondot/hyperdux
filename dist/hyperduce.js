...
var _freeze = __webpack_require__(30);
...
var _reject = __webpack_require__(31);
...
var _forEach = __webpack_require__(202);
...
var _mapValues = __webpack_require__(206);
...
var hyperduce = function hyperduce(_ref) {
  ...
  var selectedAdapter = restAdapter(url, identity, adapter, request);
  return {
...
var restAdapter = function restAdapter(url, identity, adapter, adapterOpts) {
  ...
  return {
    create: function create(data, requestOpts) {
      return adapter((0, _extends3.default)({}, adapterOpts, { method: 'post', url: url }), data, requestOpts);
    },
    all: function all(data, requestOpts) {
      return adapter((0, _extends3.default)({}, adapterOpts, { method: 'get', url: url }), data, requestOpts);
    },
    destroy: function destroy(data, requestOpts) {
      return adapter((0, _extends3.default)({}, adapterOpts, { method: 'delete', url: url + '/' + data[identity] }), data, requestOpts);
    },
    update: function update(data, requestOpts) {
      return adapter((0, _extends3.default)({}, adapterOpts, { method: 'put', url: url + '/' + data[identity] }), data, requestOpts);
    },
  ...
  return function () {
    ...
    return function (dispatch) {
      ...
      return req.apply(undefined, args).then(function (response) {
        ...
        return dispatch({ type: type.REJECTED, causer: payload, payload: err });
      });
    };
  };
};
...
$export($export.S + $export.F * !__webpack_require__(17), 'Object', {defineProperty: __webpack_require__(54).f});
...
var _constant = __webpack_require__(134);
...
var _is = __webpack_require__(135);

var _is2 = _interopRequireDefault(_is);

var _if2 = __webpack_require__(201);

var _if3 = _interopRequireDefault(_if2);

var _ifElse = __webpack_require__(84);
...
var _omit = __webpack_require__(207);

var _omit2 = _interopRequireDefault(_omit);

var _omitBy = __webpack_require__(241);

var _omitBy2 = _interopRequireDefault(_omitBy);

var _reject = __webpack_require__(246);
...
var _updateIn = __webpack_require__(247);

var _updateIn2 = _interopRequireDefault(_updateIn);

var _withDefault = __webpack_require__(248);
...
var _splitPath = __webpack_require__(60);
...
var arrayEach = __webpack_require__(87),
    ...
    castFunction = __webpack_require__(203),
    isArray = __webpack_require__(0);
...
var _omit2 = __webpack_require__(208);
...
var arrayMap = __webpack_require__(24),
    baseClone = __webpack_require__(209),
    baseUnset = __webpack_require__(230),
    ...
    getAllKeysIn = __webpack_require__(50);
...
var cloneArrayBuffer = __webpack_require__(51),
    ...
    cloneRegExp = __webpack_require__(223),
    cloneSet = __webpack_require__(224),
...
var flatten = __webpack_require__(235),
...
var _omitBy2 = __webpack_require__(242);
...
var baseGet = __webpack_require__(23),
    baseSet = __webpack_require__(245),
    castPath = __webpack_require__(9);
...
var baseFlatten = __webpack_require__(93),
    baseIteratee = __webpack_require__(8),
    baseRest = __webpack_require__(250),
    baseUniq = __webpack_require__(251),
